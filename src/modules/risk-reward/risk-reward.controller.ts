...
export class RiskRewardController {
  ...
  @ApiOperation({
    summary: 'Get risk/reward score (latest or history)',
    description: 'Retrieves the calculated R/R score for a symbol.',
  })
  ...
  @ApiQuery({
    ...
    required: false,
    example: 'true',
    description: 'Set to "true" to get historical scores.',
  })
  @ApiResponse({
    status: 200,
