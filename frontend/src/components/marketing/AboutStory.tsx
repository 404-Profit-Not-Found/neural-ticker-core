        ...
        <div className="space-y-24">
            ...
            <section className="grid md:grid-cols-2 gap-12 items-center animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
                ...
                <div className="relative group">
                    ...
                    <Card className="relative p-8 bg-card/80 dark:bg-card/50 backdrop-blur-md border-border/50 overflow-hidden shadow-xl dark:shadow-none">
                        <div className="absolute top-0 right-0 p-4 opacity-5 dark:opacity-10 text-foreground">
                            <Brain size={120} />
                        </div>
                        <h3 className="text-lg font-semibold mb-4 text-foreground relative z-10">The Old Way vs. NeuralTicker</h3>
                        <ul className="space-y-4 relative z-10">
                            <li className="flex items-start gap-3 text-sm text-muted-foreground">
                                <div className="min-w-[24px] h-6 flex items-center justify-center rounded bg-red-500/10 text-red-600 dark:text-red-500 font-bold">✕</div>
                            ...
                            <li className="flex items-start gap-3 text-sm text-foreground font-medium">
                                <div className="min-w-[24px] h-6 flex items-center justify-center rounded bg-green-500/10 text-green-600 dark:text-green-500 font-bold">✓</div>
