...
import { TrendingUp, TrendingDown, ArrowUp, Bot } from 'lucide-react';
...
export function PortfolioGridView({ data, isLoading }: PortfolioGridViewProps) {
      ...
      {data.map((item) => {
        ...
        return (
          ...
          >
             ...
             {/* Risk Indicator (Absolute bottom) */}
             <div className="absolute top-5 right-5 opacity-0 group-hover:opacity-100 transition-opacity">
                  {/* Or just show it? Analyzer shows badges. Let's show Risk bottom left maybe? */}
             </div>
          </div>
        );
      })}
