    ...
    return createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6" {...props}>
            ...
            <div
                ref={ref}
                className={cn(
                    "relative w-full max-w-lg transform overflow-hidden rounded-lg border bg-background p-6 text-left shadow-xl transition-all animate-in slide-in-from-bottom-10 sm:max-w-3xl sm:slide-in-from-bottom-0 sm:zoom-in-95 data-[state=open]:fade-in-0",
                    className
                )}
            >
                {children}
